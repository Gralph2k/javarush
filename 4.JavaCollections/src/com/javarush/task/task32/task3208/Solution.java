...
public class Solution {
    ...
    public static final String UNIC_CAT_NAME="cat.service";
    public static final String UNIC_DOG_NAME="dog.service";
    ...
    public static Thread SERVER_THREAD = new Thread(new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                Remote cat_remote = UnicastRemoteObject.exportObject(cat, 0);
                Remote dog_remote = UnicastRemoteObject.exportObject(dog, 0);
                registry.bind(UNIC_CAT_NAME, cat_remote);
                registry.bind(UNIC_DOG_NAME, dog_remote);
            }
